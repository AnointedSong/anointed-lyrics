            ...
            {!isMobile && (
              <nav style={{ display: "flex", alignItems: "center", gap: 2 }}>
                {navItems.map(({ href, label }) => {
                  ...
                  return (
                    <Link key={href} href={href}
                      style={{ padding: "6px 8px", fontSize: 12, color: active ? C.fg : C.muted, textDecoration: "none", position: "relative", fontWeight: active ? 500 : 400 }}>
                      {label}
                ...
                <button onClick={onSignOut}
                  style={{ padding: "6px 8px", fontSize: 12, color: C.muted, background: "none", border: "none", cursor: "pointer", fontFamily: font.body }}>
                  Sign Out
                </button>
              </nav>
            )}
